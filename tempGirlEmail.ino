...
char auth[] = "rDLbaxEHhWxvFzltZ8XDbglVufooVlKl";


// Your WiFi credentials.
// Set password to "" for open networks.
char ssid[] = "ASUS AC1750";
char pass[] = "9072768838";
...
#define MASTER_BRIGHTNESS  100  // change this to change overall brightness
bool check = true;
#define STARTING_BRIGHTNESS 200  // change this to change maximum brightness
...
void myTempEvent()
{
  ...
  if(Fahrenheit <  55 && check == true){
   Blynk.email("korshino@gmail.com", "TempGirl Alert", "Temperature under 55!");
   check = false;
    izzy = 0;
  }
  izzy++;
  if(izzy > 500) check = true;
...
void setup() {
  ...
  timer_temp.setInterval(100000L, myTempEvent);
}
...
#define BITS_PER_DIRECTION_FLAG 8
